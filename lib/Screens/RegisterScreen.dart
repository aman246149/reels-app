      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text("Register",style: TextStyle(color: primaryColor,fontSize: 30),),
            ...
            InkWell(onTap: (){
              ...
              child: Container(
                ...
                color: Colors.red,
                child: const Center(child:  Text("Register",style: TextStyle(color: primaryColor,fontSize: 25,fontWeight: FontWeight.bold),)),
              ),
            ),
            ...
            InkWell(
              ...
              child: RichText(text: const TextSpan(
                  children: [
                    TextSpan(text:"Already have an account ?",style: TextStyle(color: primaryColor,fontSize: 16)),

                    TextSpan(text: "   Login",style: TextStyle(color: Colors.red,fontSize: 16))
                  ]
              )),
            )
          ],
